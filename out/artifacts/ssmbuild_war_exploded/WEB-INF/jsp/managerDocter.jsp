    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <table class="table table-hover table-striped">
                ...
                <tbody>
                <c:forEach var="docter" items="${requestScope.get('list')}" varStatus="statu">
                    <tr>
                        <td>${statu.count}</td>
                        <td>${docter.getDaccount()}</td>
                        <td>${docter.getDname()}</td>
                        <td>${docter.getAddtime()}</td>
                        <td>
